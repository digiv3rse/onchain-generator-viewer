...
function App() {
    ...
    async function fetchTokenData() {
      ...
      try {
        ...
        const data = await publicClient.readContract({
          ...
          abi: DiGiGenArt721GeneratorV0Abi,
  ...
  return (
    <TooltipProvider>
      <div className="flex w-full mx-auto px-4 py-8 pb-14 md:py-12 justify-center items-center">
        <div className="w-4/5">
          <img src="https://assets.kimhabork.com/logo-color.svg" className="w-full block" alt="logo" />
        </div>
      </div>
